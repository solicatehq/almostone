    ...
    <nav className="fixed top-4 left-0 right-0 z-50 px-4 md:px-8 flex justify-center w-full">
      <div className="w-full max-w-5xl bg-white/40 backdrop-blur-md border border-white/40 rounded-full px-6 py-3 flex items-center justify-between shadow-lg shadow-pastel-mauve/10 transition-all hover:bg-white/60">
        ...
        <div className="flex items-center gap-3">
            ...
            <button className="group flex items-center gap-1.5 bg-gradient-to-r from-pastel-mauve to-pastel-frosted text-white pl-5 pr-4 py-2 rounded-full text-sm font-semibold shadow-md shadow-pastel-mauve/30 hover:shadow-lg hover:shadow-pastel-mauve/40 hover:-translate-y-0.5 hover:scale-105 transition-all active:scale-95">
            Onboard Now
